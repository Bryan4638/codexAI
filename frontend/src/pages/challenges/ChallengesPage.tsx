            ...
            return (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <span
                    className={`text-xs px-2 mb-4 py-0.5 rounded-full border ${difficultyColors[challenge.difficulty] || ''}`}
                  >
                  ...
                  {user && user.username === challenge.author?.username && (
                    <button
                      ...
                      className="bg-transparent hover:text-red-500 transition-colors duration-300 text-text-muted border-none cursor-pointer text-base"
                      title="Eliminar reto"
                    >
                      <IconTrash />
                    </button>
