    ...
    <header className="header">
      <div className="header-content">
        ...
        <nav className={`nav ${isMenuOpen ? "open" : ""}`}>
          ...
          <Link
            className={`nav-link ${currentPath === "/modulos" ? "active" : ""}`}
            to="/modulos"
          >
            Módulos
          </Link>
          <Link
            className={`nav-link ${currentPath === "/medallas" ? "active" : ""}`}
            to="/medallas"
          >
            Medallas
          </Link>
          <Link
            className={`nav-link ${currentPath === "/ranking" ? "active" : ""}`}
            to="/ranking"
          >
            Ranking
          </Link>
          <Link
            className={`nav-link ${currentPath === "/retos" ? "active" : ""}`}
            to="/retos"
          >
            Retos
          </Link>
